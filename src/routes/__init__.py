...
def register_routes(app):
    register_read_links_route(app)
    register_create_link_route(app)
    register_read_link_by_id_route(app)
    register_update_link_by_id_route(app)
    register_delete_link_by_id_route(app)
